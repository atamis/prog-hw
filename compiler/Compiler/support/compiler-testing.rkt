...
(define-simple-check (check-aeq? e1-compiled e2)
  (alpha-equivalent? e1-compiled e2))

(define-for-syntax ((compile/check-aeq? this-pass) loc e1 e2)
  (with-syntax ([e1 e1][e2 e2][e1-out #'e1-out])
