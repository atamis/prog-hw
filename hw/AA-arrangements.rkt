...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname AA-arrangements) (read-case-sensitive #t) (teachpacks ((lib "arrangements-teachpack.ss" "installed-teachpacks"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "arrangements-teachpack.ss" "installed-teachpacks")))))
...
(check-expect (arrangements (list "d" "e"))
  '(("d" "e") ("e" "d")))
(check-expect (arrangements (list "d" "e" "f"))
  '(("d" "e" "f") ("d" "f" "e")
    ("e" "d" "f") ("e" "f" "d")
    ("f" "d" "e") ("f" "e" "d")))
